    ...
    class UiComponantes{
        ...
        public void registerUndoButton(){
            undoButton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                   shapeContainer.remove(shapeContainer.size() - 1);
                    repaint();
                }
            });
        }
        ...
        public void registerRectButton(){	
			rectButton.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e){
                    currentState = ButtonState.RECTANGLE_BUTTON;
				}
			});
		}
        public void registerLineButton(){	
			lineButton.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e){
					currentState = ButtonState.LINE_BUTTON;
				}
			});
		}
        public void registerOvalButton(){
            ovalButton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
					currentState = ButtonState.OVAL_BUTTON;
				}
            });
        }
        public void registerPencilButton(){
            pencilButton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                    currentState = ButtonState.PENCIL_BUTTON;
                }
            });
        }
        public void registerEraserButton(){
            eraserButton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                    currentState = ButtonState.ERASER_BUTTON;
                }
            });
        }
        public void registerSolidBox(){
			solidBox.addItemListener(new ItemListener(){
				public void itemStateChanged(ItemEvent e){
						isSolidBoxActives = !isSolidBoxActives;
				}
			});
		}
